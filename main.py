...
# CodeSandbox ke liye keep-alive server
app = Flask('')

@app.route('/')
def home():
    return "🤖 Telegram Bot is Running on CodeSandbox!"
...
print("🚀 Starting Telegram Bot on CodeSandbox...")
...
async def main():
    ...
    print("✅ CodeSandbox Bot Started Successfully!")
    print("🤖 Smart Auto-Toggle Features Active!")
    print("🌐 Bot is running 24/7 on CodeSandbox!")
